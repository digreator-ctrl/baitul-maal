  ...
  return (
    <div className="animate-fade-in-up pb-xl">
      <div className="card text-center" style={{ padding: '64px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '16px' }}>
        ...
        <h2 className="font-bold text-2xl">Laporan Posisi Saldo</h2>
        ...
        <p className="text-secondary" style={{ maxWidth: '600px', margin: '0 auto', lineHeight: '1.6' }}>
          Halaman laporan ini sedang dalam tahap pengembangan dan perancangan. Kami sedang menyesuaikan struktur pelaporan (Neraca / Posisi Keuangan) agar sesuai dengan standar akuntansi Baitul Maal yang tepat.
        </p>
      </div>
    </div>
  );
