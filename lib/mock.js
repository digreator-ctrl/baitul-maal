...
export const mockSetoran = [
  {
    id: 's1', petugasId: 'u4', tanggal: '2025-06-12', status: 'terverifikasi',
    donasiIds: ['dn1', 'dn2', 'dn4'], totalNominal: 2250000,
    verifikasiOleh: 'u3', tanggalVerifikasi: '2025-06-13', catatan: ''
  },
  {
    id: 's2', petugasId: 'u5', tanggal: '2025-06-08', status: 'terverifikasi',
    donasiIds: ['dn3'], totalNominal: 2500000,
    verifikasiOleh: 'u3', tanggalVerifikasi: '2025-06-09', catatan: ''
  },
  {
    id: 's3', petugasId: 'u4', tanggal: '2025-06-22', status: 'menunggu_verifikasi',
    donasiIds: ['dn5', 'dn6', 'dn9'], totalNominal: 5700000,
...
export function getStatusBadge(status) {
  switch(status) {
    case 'belum_disetor': return { label: 'Belum Disetor', variant: 'warning' };
